...
Western_Europe %>% 
  ...
  geom_line() + # Tilføjer linjer til plottet
  labs(title = "Homicides per 100k in Western Europe",
       x = "Year",
       y = "Homicides per 100k",
       color = "Country") + # Tilføjer labels
  theme_minimal() # Anvender et minimalistisk tema
```
